...
const blurHeader = () =>{
    ...
    this.scrollY >= 350 ? header.classList.add('blur-header') 
...
const scrollUp = () =>{
    ...
    // When the scroll is higher than 350 viewport height, add the show-scroll class to the a tag with the scrollup class - Cuando el desplazamiento sea mayor a la altura de la ventana gráfica 350, agregue la clase show-scroll a la etiqueta a con la clase scrollup 
...
sr.reveal(`.home_card`, { delay: 600, distance: '60px', interval: 100 })
